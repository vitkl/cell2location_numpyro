...
pip install -q --prefix /usr/local pip install --upgrade numpyro jax==0.2.3 jaxlib==0.1.56+cuda102 -f https://storage.googleapis.com/jax-releases/jax_releases.html
